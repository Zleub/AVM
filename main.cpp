...
//   odddddddd/`:-`sdddddddds    @Modified: 2017-05-10T20:24:34+02:00
//    +ddddddh`+dh +dddddddo
//     -sdddddh///sdddddds-
//       .+ydddddddddhs/.
//           .-::::-`
...
int main(int ac, char *av[])
{
	...
	// };
	//
	// std::transform(deque.begin(), deque.end(), [](std::string s) {
	// 	return s.substr(0, 2);
	// });
	//
	// std::for_each(deque.begin(), deque.end(), [](std::string s) {
	// 	std::cout << s << std::endl;
	// });
